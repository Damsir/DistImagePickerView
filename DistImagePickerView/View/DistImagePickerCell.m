...
@implementation DistImagePickerCell
...
- (void)layoutSubviews {
    ...
    _videoImageView.frame = CGRectMake((self.bounds.size.width-LLPickerVideoPlayButtonWidth)/2, (self.bounds.size.width-LLPickerVideoPlayButtonWidth)/2, LLPickerVideoPlayButtonWidth, LLPickerVideoPlayButtonWidth);
}

- (void)clickDeleteButton {
    
    !_DistClickDeleteButton ?  : _DistClickDeleteButton(self.cellIndexPath);
}
